         ...
         <nav class="sidebar">
            <ul class="nav">
                  ...
                  <ul class="nav collapse ">
                     <li>
                        <a href="<?php echo base_url();?>welcome" title="Flot" data-toggle="" class="no-submenu">
                           <span class="item-text">Crear Estudiante</span>
                        </a>
                     </li>
                  </ul>
                  <!-- END SubMenu item-->
               ...
               <li>
                  ...
                  <ul class="nav collapse ">
                     <li>
                        <a href="<?php echo base_url();?>assets/table-datatable.html" title="Data Table" data-toggle="" class="no-submenu">
                           <span class="item-text">Crear Curso</span>
                        </a>
                     </li>
                  </ul>
                  <!-- END SubMenu item-->
