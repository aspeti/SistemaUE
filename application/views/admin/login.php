      ...
      <div class="col-lg-3 col-md-6 col-sm-8 col-xs-12 align-middle">
         ...
         <div data-toggle="play-animation" data-play="fadeInUp" data-offset="0" class="panel panel-default panel-flat">
            <p class="text-center mb-lg">
               <br>
               <a href="#">
                  <img src="<?php echo base_url();?>assets/app/img/logo3.png" alt="Image" class="block-center img-rounded">
               </a>
            </p>
            <p class="text-center mb-lg">
            ...
            <div class="panel-body">
               <form action="<?php echo base_url();?>auth/login" method="post" role="form" class="mb-lg">
                  ...
                  <div class="text-right mb-sm"><a href="#" class="text-muted">Necesitas registrarte?</a>
                  </div>
                  <div class="form-group has-feedback">
                     <input id="exampleInputEmail1" type="text" name="username" placeholder="Ingresa tu usuario" class="form-control">
